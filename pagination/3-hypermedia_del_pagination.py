...
class Server:
    ...
    def get_hyper_index(self, index: int = None, page_size: int = 10) -> Dict:
        ...
        # Verify whether the specified i is present in the indexed dataset
        if index is not None and index not in self.indexed_dataset():
            # If the specified i is not present,locate the next available index
            next_index = index + 1
            ...
            # Use the given i, or start from the beginning if none is provided
